...
<div class="wrapper">
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Indra Hasan</span>
            </a>
                    ...
                    foreach ($m['admin-route'] as $route => $r) {
                        if ($route == 'get') {
                            foreach ($r as $method) {
                                if ($method == 'index') {
                                    echo '<li>
                                            <a href="'.url($menu.'/'.$method).'"><i class="fa fa-'.$m['icon'].'"></i> '.$m['title'].'</a>
                                        </li>';
                                }
                            }
                        }
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2019 <a href="#">Indra Hasan</a>.</strong> All rights
    reserved.
  </footer>
